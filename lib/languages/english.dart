...
class English {
  ...
  Map<String, String> get translations => {
    ...
    /// Side Panel
      /// Home
      key.homeBanner: 'Banner',
      key.homeContent: 'Content',

      /// Projects Management
      key.projectsManagement: 'Projects Management',
      key.projects: 'Projects',

      /// Packages Management
      key.packagesManagement: 'Packages Management',

      /// Customer Management
      key.messages: 'Messages',
      key.messagesList: 'Messages List',
    ...
    key.monitorYourPortfolioStatistics: 'Monitor your portfolio statistics',
    key.totalApps: 'Total Apps',
    key.mobileApps: 'Mobile Apps',
    key.webApps: 'Web Apps',
    key.desktopApps: 'Desktop Apps',
    ...
    key.underDevelopment: 'Under Development',
    key.projectName: 'Project Name',
    key.description: 'Description',
    key.projectList: 'Project List',
    ...
    key.searchProject: 'Search Project',
    key.projectStatus: 'Project Status',
    ...
    /// Customer Management ///
      ...
      key.messagesAnalyticalData: 'Messages Analytical Data',
      key.totalMessages: 'Total Messages',
      key.totalSpent: 'Total Spent',
      key.gender: 'Gender',
      key.male: 'Male',
      key.female: 'Female',
      key.other: 'Other',
      key.searchMessage: 'Search Message',
  ...
  /// Customer Management End ///
    ...
    key.fileInstructions: 'File Format - .mp4, .WebM - Maximum Size 20MB',
    ...
    key.descTooShort: 'Description too short',
