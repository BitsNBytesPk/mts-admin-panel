...
/// Side Panel
  ...
  /// Projects Management
  const projectsManagement = 'projectsManagement',
      projects = 'projects';

  /// Packages Management ///
  const packagesManagement = 'packagesManagement';

  /// Messages
  const messages = 'messages',
      messagesList = 'messgesList';
...
const welcomeAdmin = 'welcomeAdmin',
    monitorYourPortfolioStatistics = 'monitorYourPortfolioStatistics',
    totalApps = 'totalApps',
...
/// Messages ///
  ...
  const messagesAnalyticalData = 'messagesAnalyticalData',
      totalMessages = 'totalMessages',
      totalSpent = 'totalSpent',
      gender = 'gender',
      searchMessage = 'searchMessage';
  /// Messages List Screen End ///
