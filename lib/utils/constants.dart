...
List<SidePanelItemData> sidePanelItemsData = [
  ...
  SidePanelItemData(routeName: Routes.aboutBanner, scrollPosition: 130.0, sidePanelItemIndex: 3),
  SidePanelItemData(routeName: Routes.aboutContent, scrollPosition: 130.0, sidePanelItemIndex: 4),
  SidePanelItemData(routeName: Routes.innovationBanner, scrollPosition: 130.0, sidePanelItemIndex: 5),
  SidePanelItemData(routeName: Routes.innovationContent, scrollPosition: 130.0, sidePanelItemIndex: 6),
  SidePanelItemData(routeName: Routes.responsibilityBanner, scrollPosition: 130.0, sidePanelItemIndex: 7),
  SidePanelItemData(routeName: Routes.responsibilityContent, scrollPosition: 130.0, sidePanelItemIndex: 8),
