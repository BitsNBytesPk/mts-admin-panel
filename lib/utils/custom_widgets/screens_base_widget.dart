...
import 'package:mts_website_admin_panel/utils/custom_widgets/custom_appbar.dart';
import 'package:mts_website_admin_panel/utils/custom_widgets/loader_view.dart';
import 'package:mts_website_admin_panel/utils/custom_widgets/sidepanel.dart';
...
class ScreensBaseWidget extends StatelessWidget {
  ...
  final int selectedSidePanelItem;
        ...
        body: GestureDetector(
          ...
          child: Stack(
            children: [
              Row(
                    children: [
                      if(!isSmallScreen(context)) SidePanel(
      ...
      child: Container(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                onTap: () => Get.offAllNamed(Routes.login, arguments: {'check': false}),
                minTileHeight: 20,
