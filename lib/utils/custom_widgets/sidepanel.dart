      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _SidePanelItem(text: 'Projects', routeName: Routes.homeProjects , itemIndex: 2, args: args,),
            _SidePanelItem(text: 'Timer Banner', routeName: Routes.homeTimerBanner , itemIndex: 3, args: args,),
            _SidePanelHeading(text: 'About', icon: CupertinoIcons.info_circle,),
            _SidePanelItem(text: 'Banner', routeName: Routes.aboutBanner, itemIndex: 4, args: args,),
            _SidePanelItem(text: 'Content', routeName: Routes.aboutContent, itemIndex: 5, args: args,),
            _SidePanelHeading(text: 'Innovation', image: ImagesPaths.innovation),
            _SidePanelItem(text: 'Banner', routeName: Routes.innovationBanner, itemIndex: 6, args: args,),
            _SidePanelItem(text: 'Content', routeName: Routes.innovationContent, itemIndex: 7, args: args,),
            _SidePanelHeading(text: 'Responsibility', icon: Icons.energy_savings_leaf_outlined,),
            _SidePanelItem(text: 'Banner', routeName: Routes.responsibilityBanner, itemIndex: 8, args: args,),
            _SidePanelItem(text: 'Content', routeName: Routes.responsibilityContent, itemIndex: 9, args: args,),
            _SidePanelItem(text: 'Projects', routeName: Routes.responsibilityProjects, itemIndex: 10, args: args,),
            _SidePanelHeading(text: 'Contact', icon: Icons.contact_page_outlined,),
            _SidePanelItem(text: 'Banner', routeName: Routes.contactBanner, itemIndex: 11),
            _SidePanelItem(text: 'Content', routeName: Routes.contactContent, itemIndex: 12),
            _SidePanelHeading(text: 'Shared Data', image: ImagesPaths.sharedData,),
            _SidePanelItem(text: 'Footer', routeName: Routes.footer, itemIndex: 13, args: args,),
            // _SidePanelItem(text: 'Footer', routeName: Routes.homeBanner, itemIndex: 10, args: args,),
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => Container(
          ...
          child: ListTile(
            ...
            minTileHeight: 40,
            onTap: GlobalVariables.selectedSidePanelItemIndex.value == itemIndex ? null : () => Get.offAllNamed(routeName, arguments: args,),
            title: Text(
              text,
