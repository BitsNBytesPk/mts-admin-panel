      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _SidePanelItem(text: 'Banner', routeName: Routes.aboutBanner, itemIndex: 3, args: args,),
            _SidePanelItem(text: 'Content', routeName: Routes.aboutContent, itemIndex: 4, args: args,),
            _SidePanelHeading(text: 'Innovation', image: ImagesPaths.innovation),
            _SidePanelItem(text: 'Banner', routeName: Routes.innovationBanner, itemIndex: 5, args: args,),
            _SidePanelItem(text: 'Content', routeName: Routes.innovationContent, itemIndex: 6, args: args,),
            _SidePanelHeading(text: 'Responsibility', icon: Icons.energy_savings_leaf_outlined,),
            _SidePanelItem(text: 'Banner', routeName: Routes.responsibilityBanner, itemIndex: 7, args: args,),
            _SidePanelItem(text: 'Content', routeName: Routes.responsibilityContent, itemIndex: 8, args: args,),
            _SidePanelHeading(text: 'Shared Data', image: ImagesPaths.sharedData,),
            _SidePanelItem(text: 'Footer', routeName: Routes.homeBanner, itemIndex: 9, args: args,),
